 ...
 * @author ril3y
 */
public class BootloaderSerialDriver implements SerialPortEventListener {
    
    private static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(BootloaderSerialDriver.class);
    ...
    public boolean initialize(String port, int DATA_RATE) {
        ...
        try {
            ...
            serialPort = (SerialPort) portId.open("TG-FIRMWARE", TIME_OUT);
            // set port parameters
